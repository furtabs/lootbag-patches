...
fun Entity.setShootMovementFromRotation(
    ...
    val random = shooter.level().random
...
fun Entity.setShootMovementFromRotation(
    ...
    applyShootDelta(f, f1, f2, velocity, inaccuracy, random)
...
fun Entity.setShootMovement(
    ...
    applyShootDelta(x, y, z, velocity, inaccuracy, level().random)
}

private fun Entity.applyShootDelta(
    x: Double,
    y: Double,
    z: Double,
    velocity: Float,
    ...
    val vec3 = getMovementToShoot(x, y, z, velocity, inaccuracy, random)
    deltaMovement = vec3
    hasImpulse = true
...
private fun getMovementToShoot(
    x: Double,
    y: Double,
    z: Double,
    velocity: Float,
